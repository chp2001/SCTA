...
Factions = {
    ...
    },
    {
        ...
        DefaultSkin = 'nomads',
        loadingMovie = '/seraphim_load.sfd',
        loadingColor = 'FFbadbdb',
        loadingTexture = '/seraphim_load.dds',
        IdleEngTextures = {
    ...
    },
    {
        ...
        TransmissionLogColor = 'ff0000ff',
        Icon = "/widgets/faction-icons-alpha_bmp/arm_ico.dds",
        VeteranIcon = "/game/veteran-logo_bmp/arm-veteran_bmp.dds",
        ...
        loadingTexture = '/UEF_load.dds',
        IdleEngTextures = {
            T1 = '/icons/units/armck_icon.dds',
            T2 = '/icons/units/armack_icon.dds',
            T3 = '/icons/units/xsl0309_icon.dds',
            SCU = '/icons/units/xsl0301_icon.dds',
        },
        IdleFactoryTextures = {
            LAND = {
                '/icons/units/armlab_icon.dds',
                '/icons/units/armalab_icon.dds',
                '/icons/units/xsb0301_icon.dds',
            },
            AIR = {
                '/icons/units/armap_icon.dds',
                '/icons/units/armaap_icon.dds',
                '/icons/units/xsb0302_icon.dds',
            },
            NAVAL = {
                '/icons/units/armsy_icon.dds',
                '/icons/units/armasy_icon.dds',
                '/icons/units/xsb0303_icon.dds',
            },
        },
    },

    {
        ...
        TransmissionLogColor = 'ffff0000',
        Icon = "/widgets/faction-icons-alpha_bmp/core_ico.dds",
        VeteranIcon = "/game/veteran-logo_bmp/core-veteran_bmp.dds",
        SmallIcon = "/faction_icon-sm/core_ico.dds",
        LargeIcon = "/faction_icon-lg/core_ico.dds",
        TooltipID = 'lob_core',
        DefaultSkin = 'cybran',
        loadingMovie = '/movies/cybran_load.sfd',
        loadingColor = 'FFe24f2d',
        loadingTexture = '/cybran_load.dds',
        IdleEngTextures = {
            T1 = '/icons/units/corck_icon.dds',
            T2 = '/icons/units/corack_icon.dds',
            T3 = '/icons/units/xsl0309_icon.dds',
            SCU = '/icons/units/xsl0301_icon.dds',
        },
        IdleFactoryTextures = {
            LAND = {
                '/icons/units/corlab_icon.dds',
                '/icons/units/coralab_icon.dds',
                '/icons/units/xsb0301_icon.dds',
            },
            AIR = {
                '/icons/units/corap_icon.dds',
                '/icons/units/coraap_icon.dds',
                '/icons/units/xsb0302_icon.dds',
            },
            NAVAL = {
                '/icons/units/corsy_icon.dds',
                '/icons/units/corasy_icon.dds',
                '/icons/units/xsb0303_icon.dds',
            },
        },
    },
