...
PlatoonTemplate {
    ...
    Plan = 'EngineerBuildAISCTA',
    GlobalSquads = {
        { categories.ENGINEER * (categories.LEVEL1 + categories.LEVEL2 + categories.LEVEL3) - categories.COMMAND, 1, 1, 'support', 'None' }
    },
}
...
PlatoonTemplate {
    ...
    Plan = 'EngineerBuildAISCTA',
    GlobalSquads = {
        { categories.ENGINEER * (categories.LEVEL2 + categories.LEVEL3) - categories.COMMAND, 1, 1, 'support', 'None' }
    },
}
...
PlatoonTemplate {
    ...
    Plan = 'EngineerBuildAISCTA',
    GlobalSquads = {
        { categories.ENGINEER * (categories.LEVEL1 + categories.LEVEL2) - categories.COMMMAND, 1, 1, 'support', 'None' }
    },
}
...
PlatoonTemplate {
    ...
    Plan = 'EngineerBuildAISCTA',
    GlobalSquads = {
        { categories.ENGINEER * (categories.LEVEL1 + categories.LEVEL2) * categories.AIR - categories.COMMMAND, 1, 1, 'support', 'None' }
    },
}
